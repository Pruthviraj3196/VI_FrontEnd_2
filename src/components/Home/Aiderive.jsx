...
const Aiderive = () => {
  return (
    <div>
      {/* Section 1 */}
      <div className="flex flex-col items-center gap-10 mt-20 px-10">
        <h1 className="font-extrabold text-5xl text-center text-gray-800 leading-tight">
          AI-DRIVEN INNOVATION AT GENEX
        </h1>
        <div className="flex gap-20 mt-16 items-center justify-center">
          <img
            className="w-[500px] h-[350px] object-cover rounded-xl shadow-lg"
      ...
      {/* Section 2 */}
      <div className="flex gap-20 mt-20 items-center justify-center px-10">
        <div className="w-[400px] text-left">
          <h2 className="font-semibold text-xl mb-2 text-gray-900">
      ...
      <div className="mt-24 px-10">
        <h1 className="font-extrabold text-4xl text-center text-gray-800 leading-tight">
        ...
        <div className="flex gap-16 mt-10 items-center justify-center">
          ...
          <img
            className="w-[550px] h-[400px] object-cover rounded-xl shadow-lg"
