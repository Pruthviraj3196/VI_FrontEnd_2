...
const Aboutus = () => {
  return (
    <div className="w-11/12 max-w-6xl mx-auto py-10">
      ...
      <div className="mb-10">
        <h2 className="text-5xl font-bold ml-96  mb-7">FEATURED ARTICLES</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center text-center p-5 bg-white shadow-lg rounded-lg">
            ...
            <p className="text-sm">
            Data discovery is the new normal, but where do
            we go from here?
            Smart data discovery has the potential to
            expand access to sophisticated interactive
            analysis and insights to business consumers and
            nontraditional BI users the approximately 70
            percent of users in organizations that currently
            do not use BI tools
